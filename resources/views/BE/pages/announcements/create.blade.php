                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0"><i class="ti ti-speakerphone me-2 text-primary"></i>Tambah pengumuman</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('announcements.store') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder=" " required autocomplete="off">
                            ...
                            <div class="form-floating mb-3">
                                <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" placeholder=" " style="height: 220px" rows="8" required>{{ old('content') }}</textarea>
                            ...
                            <div class="form-check form-switch mb-4">
                                <input type="checkbox" name="is_published" id="is_published" value="1" class="form-check-input" role="switch" @checked(old('is_published'))>
