...
setTimeout(function () {
  (function () {
    ...
    var options_bar_chart_2 = {
      ...
      colors: ['#0a5e59', '#2CA87F', '#E58A00', '#13c2c2'],
      responsive: [
        {
          breakpoint: 480,
          options: {
    ...
    var options_bar_chart_4 = {
      ...
      colors: ['#0a5e59', '#13c2c2', '#2CA87F', '#E58A00', '#DC2626'],
      stroke: {
        width: 1,
        colors: ['#fff']
      },
    ...
    var options_bubble_chart_1 = {
      ...
      colors: ['#0a5e59', '#2CA87F', '#E58A00', '#DC2626'],
      fill: {
        opacity: 0.8
      },
      xaxis: {
    ...
    var options_scatter_chart_1 = {
      ...
      colors: ['#0a5e59', '#2CA87F', '#DC2626', '#E58A00', '#13c2c2'],
      series: [
        {
          name: 'SAMPLE A',
          data: [
    ...
    var options_pie_chart_1 = {
      ...
      colors: ['#0a5e59', '#2CA87F', '#13c2c2', '#E58A00', '#DC2626'],
      legend: {
        show: true,
        position: 'bottom'
      },
